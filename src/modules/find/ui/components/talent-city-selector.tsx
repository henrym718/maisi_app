...
import { CheckIcon, PlusIcon, PlusSquareIcon, Search } from "lucide-react";
  ...
  return (
    <div>
      ...
      <div
        ...
        className="flex items-center justify-between px-4 py-3 border border-gray-200 rounded-xl mb-4 cursor-pointer hover:bg-gray-50 transition-colors"
      >
        <span className="text-md text-gray-800">
          Buscar en cualquier ciudad de Ecuador
        </span>
        ...
        {ciudadesParaMostrar.map((city) => {
          ...
          return (
            <div
              ...
              className={cn(
                "flex items-center justify-center cursor-pointer rounded-md py-1.5 px-4 text-center font-semibold text-sm transition-all duration-200 border relative overflow-hidden whitespace-nowrap text-ellipsis",
                isSelected
              ...
              {filteredCities.map((city) => {
                ...
                return (
                  <div
                    ...
                    className="flex items-center justify-between p-4 mb-1 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors"
                  >
      ...
      <Button
        ...
        className={`w-full py-2 text-lg font-bold transition-all h-auto`}
      >
        Continuar
      </Button>
    </div>
